...
def build_map_dict_by_code(gdpinfo, codeinfo, plot_countries, year):
    ...
    mapped_codes, missing = reconcile_countries_by_code(
...
def render_world_map(gdpinfo, codeinfo, plot_countries, year, map_file):
    ...
    """
    mapping, missing, no_data = build_map_dict_by_code(
        gdpinfo, codeinfo, plot_countries, year)

    title = 'GDP by country for {} (log scale), unified by common country NAME'.format(
        year)
